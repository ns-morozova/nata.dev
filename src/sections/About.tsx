...
const About: React.FC = () => {
    return (
        <section id="about" className="px-4 py-8 md:px-8 md:py-16">
                ...
                <div className="flex flex-col gap-10 lg:gap-16">
                    <div className="md:max-w-2/3">
                        ...
                        <div className="flex flex-col gap-5 text-sm md:text-base">
                            ...
                            <p>
                                Вдохновлена своим делом и результатом, постоянно учусь новому, расширяю свои навыки и стремлюсь доводить работу до максимально качественного результата.
                            </p>
                            <p>
                        ...
                        <div className="flex flex-col gap-6 md:w-1/2 md:gap-8">
                            ...
                            <div className="relative pb-6 md:pb-8">
                                ...
                                <p className="mb-3 text-sm md:text-base">
                                    Апрель 2024 - текущее время (коммерция)
                                </p>
                                <p className="mb-3 text-sm md:text-base">
                                    2022-2023 (пет-проекты)
                                </p>
                                <p className="text-sm md:text-base">
                                    За это время удалось поработать с проектами для Израиля, Норвегии и России, а также принять участие в разработке сервиса маркировки товаров для стран СНГ
                                </p>
                            </div>
