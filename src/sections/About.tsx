                ...
                <div className="flex flex-col gap-10 md:gap-16">
                    <div className="md:max-w-2/3">
                        ...
                        <p className="text-sm md:text-base">
                            Всем привет! Меня зовут Наташа, я фронтенд-разработчик. <br></br>
                            ...
                            <p className="mt-5">Всегда открыта предложениям и рада новым проектам и продуктивному сотрудничеству!</p>
                        </p>
                    </div>
