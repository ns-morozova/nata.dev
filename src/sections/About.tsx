    ...
    return (
        <div className="px-4 py-8 lg:px-8 md:py-16">
            <div className="relative max-w-7xl mx-auto">
                <h2 className="mb-10 font-medium text-5xl uppercase">Обо мне</h2>
                    ...
                    <div className="w-full lg:max-w-xl lg:flex-auto">
                        ...
                        {jobOpenings.map((opening) => (
                            ...
                            <dl className="relative flex flex-wrap gap-x-3">
                                ...
                                <dd className="mt-2 w-full flex-none text-base/7">{opening.description}</dd>
                                <dt className="sr-only">Salary</dt>
                                <dd className="mt-4 text-base/7 font-semibold">{opening.salary}</dd>
