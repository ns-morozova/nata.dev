                ...
                <div className="flex flex-col gap-10 md:flex-row md:justify-between md:items-center">
                    <div className="md:w-1/2 md:flex md:flex-col">
                        ...
                        <p className="mb-4 w-4/5 text-sm sm:w-full md:text-base md:mb-10 lg:w-5/6">
                            Моя задача как фронтенд-разработчика - реализация удобного интерфейса и всей визуальной составляющей сайта (по вашему дизайну или идее) с быстрой загрузкой страниц, динамическим отображением данных и адаптивностью под любые устройства.
                        </p>
